...
export const Electric_cyl_scansScalarFieldEnumSchema = z.enum(['id','phenotyper_id','scanner_id','plant_qr_code','path','capture_date','num_frames','exposure_time','gain','brightness','contrast','gamma','seconds_per_rot','experiment_name','wave_number','plant_age_days']);
...
export const Electric_cyl_scansWhereInputSchema: z.ZodType<Prisma.Electric_cyl_scansWhereInput> = z.object({
  ...
  experiment_name: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  wave_number: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  plant_age_days: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
...
export const Electric_cyl_scansScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.Electric_cyl_scansScalarWhereWithAggregatesInput> = z.object({
  ...
  experiment_name: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  wave_number: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  plant_age_days: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
}).strict();
...
export const Electric_cyl_scansCreateInputSchema: z.ZodType<Prisma.Electric_cyl_scansCreateInput> = z.object({
  ...
  wave_number: z.number().int().gte(-2147483648).lte(2147483647).optional().nullable(),
  plant_age_days: z.number().int().gte(-2147483648).lte(2147483647).optional().nullable(),
...
export const Electric_cyl_scansUpdateInputSchema: z.ZodType<Prisma.Electric_cyl_scansUpdateInput> = z.object({
  ...
  experiment_name: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  wave_number: z.union([ z.number().int().gte(-2147483648).lte(2147483647),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  plant_age_days: z.union([ z.number().int().gte(-2147483648).lte(2147483647),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const Electric_cyl_scansUpdateWithoutElectric_cyl_imagesInputSchema: z.ZodType<Prisma.Electric_cyl_scansUpdateWithoutElectric_cyl_imagesInput> = z.object({
  ...
  experiment_name: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  wave_number: z.union([ z.number(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  plant_age_days: z.union([ z.number(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  electric_phenotypers: z.lazy(() => Electric_phenotypersUpdateOneWithoutElectric_cyl_scansNestedInputSchema).optional()
}).strict();
