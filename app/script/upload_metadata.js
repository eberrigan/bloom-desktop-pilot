...
function loadConfig() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            console.log(config.local_db_path);
            console.log(config.bloom_api_url);
            console.log(config.bloom_anon_key);
            console.log(config.bloom_scanner_username);
            console.log(config.bloom_scanner_password);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 6:
                    experiment = _k.sent();
                    if (!experiment) return [3 /*break*/, 8];
                    return [4 /*yield*/, prisma.scientist.findUnique({
                            where: { id: (_j = experiment.scientist_id) !== null && _j !== void 0 ? _j : undefined },
                        })];
                case 7:
                    _a = _k.sent();
                    return [3 /*break*/, 9];
                ...
                case 9:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 10:
                    _b = _k.sent(), plantData = _b.data, plantError = _b.error;
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 11:
                    _c = _k.sent(), scanData = _c.data, scanError = _c.error;
                    phenotyperId = void 0;
                    return [4 /*yield*/, supabase
                            .from('phenotypers')
                            .select('id')
                            ...
                            .single()];
                case 12:
                    _d = _k.sent(), existingPhenotyper = _d.data, phenoError = _d.error;
                ...
                case 13:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 14:
                    _e = _k.sent(), newPheno = _e.data, insertError_1 = _e.error;
                    if (insertError_1)
                ...
                case 16:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 17:
                    _f = _k.sent(), existingScientist = _f.data, scientistError = _f.error;
                ...
                case 18:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 19:
                    _g = _k.sent(), newScientist = _g.data, insertError_2 = _g.error;
                    if (insertError_2)
                ...
                case 21:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .single()];
                case 22:
                    _h = _k.sent(), newSettings = _h.data, insertError = _h.error;
                    if (insertError) {
