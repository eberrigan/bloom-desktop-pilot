...
export function Experiments() {
  ...
  return (
    <div className="text-lg">
      ...
      <ul data-testid="experiments-list" className="border rounded-md max-w-full mr-10 mb-10 text-sm h-64 overflow-y-auto">
         { experiments && experiments.map((experiment) => (
          <li key={experiment.id} className="mb-2" data-exp-id={experiment.id} data-exp-name={experiment.name} >
